...
namespace think\module\command;
...
class SendConfig extends Command
{
    ...
    {
        //获取默认配置文件
        $content = file_get_contents(root_path() . 'vendor/xiaoyaor/think-module/src/config.php');

        $configPath = config_path() . '/';
        $configFile = $configPath . 'module.php';
        ...
        $output->writeln('create module config ok');
    }
